        ...
        if (requestedCourse.isBlank()) {
            ...
            if (InitialCourses.contains(requestedCourse)) {
                ...
                if (Assignments.contains(requestedAssignmentTitle)) {
                    ...
                    dialog = new JDialog(this, "Requested Assignment is already present in gradebook.", true);
                    JLabel label = new JLabel("Requested Assignment (" + requestedAssignmentTitle + ") is already present in gradebook.", SwingConstants.CENTER);
                    label.setBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10));
                    dialog.add(label);
                    dialog.pack();
                    dialog.setLocationRelativeTo(this);
                ...
                JLabel label = new JLabel("Course (" + requestedCourse + ") is not present in gradebook.", SwingConstants.CENTER);
                label.setBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10));
                dialog.add(label);
                dialog.pack();
                dialog.setLocationRelativeTo(this);
